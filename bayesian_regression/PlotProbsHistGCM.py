...
#Load GCM probabilities and combine into an array
p1_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_Had85_hold.csv',delimiter=',',skiprows=1)
p2_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_Acc85_hold.csv',delimiter=',',skiprows=1)
p3_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_Can85_hold.csv',delimiter=',',skiprows=1)
p4_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_CCS85_hold.csv',delimiter=',',skiprows=1)
p5_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_CNR85_hold.csv',delimiter=',',skiprows=1)
p6_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_MPI85_hold.csv',delimiter=',',skiprows=1)
p7_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_Had45_hold.csv',delimiter=',',skiprows=1)
p8_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_ACC45_hold.csv',delimiter=',',skiprows=1)
p9_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_Can45_hold.csv',delimiter=',',skiprows=1)
p10_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_CCS45_hold.csv',delimiter=',',skiprows=1)
p11_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_CNR45_hold.csv',delimiter=',',skiprows=1)
p12_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/GCMp_MPI45_hold.csv',delimiter=',',skiprows=1)
...
GCMyears_hold = np.loadtxt('../bayesian_regression/DREAMzs1p/year62t2099.csv',delimiter=',',skiprows=1)
...
for scenario in range(6):
    ...
    percentile_fill_plot_double(plt_perc[:,0:(np.shape(prob_hold)[0]-(window-1))],plt_perc2[:,0:(np.shape(prob_hold)[0]-(window-1))],title=GCMs[scenario],ylabel='IJF Probability',scale='log',ylim=[0.0001,1],Names=RCPs,window=window,years=GCMyears_hold[(window-1):(np.shape(GCMyears_hold)[0])], xlim=[1980,2100])
del scenario, plt_perc, plt_perc2, percentiles, i
# PAPER = Moving Average in Real Space with a plot in log scale with IQR and 95% corridors
for scenario in range(6):
    percentiles = [2.5,25,50,75,97.5]
